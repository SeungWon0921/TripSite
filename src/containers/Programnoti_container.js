        ...
        <div id="container">
            ...
            <div class="bodytext_area place_area box_inner">
                <ul class="program_list clear">
                    <li>
                        <img src="/image/img_place_01.jpg" alt="이응노 미술관" class="img_place"/>
                        <h3>이응노 미술관</h3>
                        <p class="subttl">2021.01 ~ 2021.12</p>
                    ...
                    <li>
                        <img src="/image/img_place_02.jpg" alt="김유정 문학촌" class="img_place"/>
                        <h3>김유정 문학촌</h3>
                        <p class="subttl">2021.01 ~ 2021.12</p>
                        <div class="program_content">
                            <h3>김유정 문학촌</h3>
                    ...
                    <li>
                        <img src="/image/img_place_03.jpg" alt="책과 인쇄 박물관" class="img_place"/>
                        <h3>책과 인쇄 박물관</h3>
                        <p class="subttl">2021.01 ~ 2021.12</p>
                        <div class="program_content">
                    ...
                    <li>
                        <img src="/image/img_place_04.jpg" alt="백사실 현통사" class="img_place"/>
                        <h3>백사실 현통사</h3>
                        <p class="subttl">2021.01 ~ 2021.12</p>
                        <div class="program_content">
                    ...
                    <li>
                        <img src="/image/img_place_05.jpg" alt="통영 국제 음악당" class="img_place"/>
                        <h3>통영 국제 음악당</h3>
                        <p class="subttl">2021.01 ~ 2021.12</p>
                        <div class="program_content">
                    ...
                    <li>
                        <img src="/image/img_place_06.jpg" alt="아침고요 수목원" class="img_place"/>
                        <h3>아침고요 수목원</h3>
                        <p class="subttl">2021.01 ~ 2021.12</p>
                        <div class="program_content">
                    ...
                    <li>
                        <img src="/image/img_place_07.jpg" alt="제천 리솜포레스트" class="img_place"/>
                        <h3>제천 리솜포레스트</h3>
                        <p class="subttl">2021.01 ~ 2021.12</p>
                        <div class="program_content">
                    ...
                    <li>
                        <img src="/image/img_place_08.jpg" alt="정동진" class="img_place"/>
                        <h3>정동진</h3>
                        <p class="subttl">2021.01 ~ 2021.12</p>
                        <div class="program_content">
                    ...
                    <li>
                        <img src="/image/img_place_09.jpg" alt="센트럴 파크" class="img_place"/>
                        <h3>센트럴 파크</h3>
                        <p class="subttl">2021.01 ~ 2021.12</p>
                        <div class="program_content">
                    ...
                    <li>
                        <img src="/image/img_place_10.jpg" alt="석파정" class="img_place"/>
                        <h3>석파정</h3>
                        <p class="subttl">2021.01 ~ 2021.12</p>
                        <div class="program_content">
                    ...
                    <li>
                        <img src="/image/img_place_11.jpg" alt="뉴욕 공립 도서관" class="img_place"/>
                        <h3>뉴욕 공립 도서관</h3>
                        <p class="subttl">2021.01 ~ 2021.12</p>
                        <div class="program_content">
                    ...
                    <li>
                        <img src="/image/img_place_12.jpg" alt="강천산 계곡" class="img_place"/>
                        <h3>강천산 계곡</h3>
                        <p class="subttl">2021.01 ~ 2021.12</p>
                        <div class="program_content">
                            <p className="btn_more">보성 녹차밭 근처에는 최초의 군립공원이 잇다. <span class="subtxt">산으로 올라가는 길에는 맨발로 걸을 수 있는 황톳길이 있고 꼭대기에는 다리가 떨리는 구름다리가 있다.</span></p>
                        </div>
                        <p className="btn_more"><a href="">더보기</a></p>
                    </li>
                </ul>
...
export default Program_NotiContainer;