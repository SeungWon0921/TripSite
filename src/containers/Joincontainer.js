            ...
            <div class="location_area member">
                <div class="box_inner">
                    ...
                    <ul class="page_menu clear">
                        <li><Link to="/member/join" class="on">회원가입</Link></li>
                    </ul>
                </div>
            </div>
                        ...
                        <ul class="app_list">
                            <li class="clear">
                                ...
                                <div class="app_content email_area">
                                    <input type="text" class="w160" id="email_lbl" title="이메일 주소"/> <span class="ico_space">@</span> <input type="text" class="w160" id="email_lbl" title="이메일 제공업체"/>
